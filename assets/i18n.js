...
"elettrica e analogica":"electrical and analogue",
...
"Gestione elettrica e analogica dell’impianto":"Electrical and analogue plant control",
...
"Solleva e rovescia fusti, carrelli e cassoni di forma e portata diverse: l\u2019aggancio si costruisce sul contenitore che deve prendere, e l\u2019altezza di scarico si fissa su quella della tramoggia o del nastro che sta sotto. Un comando solo, e il contenitore pieno finisce dove andava svuotato.":"It lifts and tips drums, trolleys and bins of different shapes and capacities: the coupling is built around the container it has to pick up, and the discharge height is set to the hopper or the conveyor below. One control, and the full container ends up where it had to be emptied.",
"Quello che si muove resta dentro una cabina, in lamiera chiusa o in rete, e un microinterruttore sulla porta di carico tiene ferma la macchina finch\u00e9 non \u00e8 chiusa. Sulle linee di asciugatura in ambiente galvanico \u00e8 il passaggio che porta il materiale dai cassoni al rotobarile senza che nessuno debba maneggiarlo.":"Everything that moves stays inside a cabin, in closed sheet metal or mesh, and a micro-switch on the loading door holds the machine still until it is shut. On drying lines in electroplating shops this is the step that takes the material from the bins to the barrel with nobody handling it.",
"Si dimensiona sulla linea: corsa di sollevamento, potenza per i carichi fuori standard, carter chiuso o in rete, porta a battente o a ghigliottina, colore RAL. A richiesta una telecamera tiene d\u2019occhio il livello nella tramoggia e avvisa quando arriva al massimo.":"It is sized around the line: lifting stroke, power for loads beyond the standard, closed or mesh guarding, hinged or guillotine door, RAL colour. On request a camera watches the level in the hopper and warns when it reaches the top.",
...
"centrifuga disoleatrice LM mod. 660 in acciaio inox, col marchio LM e l’armadio elettrico a fianco":"LM mod. 660 oil-removal centrifuge in stainless steel, with the LM mark and the electrical cabinet alongside",
"centrifuga disoleatrice LM mod. 800 con la colonna di sollevamento del coperchio e la pompa di rilancio":"LM mod. 800 oil-removal centrifuge with the lid lifting column and the transfer pump",
...
"centrifuga disoleatrice LM mod. 660 in acciaio inox, vista di tre quarti col suo armadio elettrico":"LM mod. 660 oil-removal centrifuge in stainless steel, three-quarters on with its electrical cabinet",
...
"Come sta in linea":"How it sits in the line",
"Carico":"Loading",
"Scarico":"Unloading",
"Ciclo":"Cycle",
"Materiale":"Material",
"su nastro trasportatore":"by belt conveyor",
"per rovesciamento del cesto":"by tipping the basket",
"automatico in carico e in scarico":"automatic in loading and unloading",
"minuteria da stampatrici e rullatrici":"small parts from stamping and rolling machines",
"Verniciatura nel colore concordato":"Paint finish in the agreed colour",
"Il 270 è la taglia minore della serie. L’armadio poggia su un telaio a colonne e lo scivolo di carico si apre in avanti, con il cesto che lavora dentro la cappa chiusa: la macchina si infila dove il reparto ha poco piano a terra e il nastro può arrivare in quota.":"The 270 is the smallest size in the range. The cabinet stands on a column frame and the loading chute swings open at the front, with the basket working inside the closed hood: the machine fits where the department has little floor space and the conveyor can come in high.",
"Sulla stessa base si monta la linea intera — nastro di carico, macchina, cassone di raccolta — su un basamento unico che si sposta in un pezzo solo.":"The whole line — loading conveyor, machine, collection bin — mounts on the same base: one frame that moves in a single piece.",
"Cesto in lamiera forata dentro la cappa chiusa":"Perforated sheet basket inside the closed hood",
"Scivolo di carico ribaltabile, comandato da cilindro pneumatico":"Tipping loading chute, driven by a pneumatic cylinder",
"Telaio a colonne che lascia libero il piano sotto la macchina":"Column frame that leaves the floor under the machine clear",
"Nastro di carico che porta il pezzo in quota":"Loading conveyor that lifts the parts to height",
...
"Il 480 sta in mezzo alla serie. L’armadio è chiuso su tutti i lati, con l’oblò di ispezione sul fronte e il quadro di comando in colonna a fianco; lo scivolo di carico sporge davanti e il cesto lavora dentro la cabina.":"The 480 sits in the middle of the range. The cabinet is closed on every side, with the inspection window at the front and the control panel in a column alongside; the loading chute juts out in front and the basket works inside the enclosure.",
"È il modello che si trova installato in fila: più macchine affiancate sulla stessa linea, ognuna col suo nastro e la sua tramoggia.":"It is the model you find installed in a row: several machines side by side on the same line, each with its own conveyor and hopper.",
"Armadio chiuso su tutti i lati, con oblò di ispezione":"Cabinet closed on every side, with an inspection window",
"Quadro di comando in colonna, a fianco della macchina":"Control panel in a column, alongside the machine",
"Scivolo di carico sul fronte, sopra il punto di raccolta":"Loading chute at the front, above the collection point",
"Cesto e cono di scarico dentro la cabina":"Basket and discharge cone inside the enclosure",
"Nastro inclinato che scarica dall’alto":"Inclined conveyor that discharges from above",
"Tramoggia di raccolta sotto la bocca di scarico":"Collection hopper under the discharge mouth",
"Si affianca ad altre macchine sulla stessa linea":"Stands alongside other machines on the same line",
"Il 660 è la taglia maggiore della serie. Attorno al cesto sta una cabina chiusa, col pannello di protezione che si alza sul fronte per lasciare vedere e raggiungere l’interno; a fianco sale la colonna che porta la tramoggia in quota.":"The 660 is the largest size in the range. A closed enclosure surrounds the basket, with the guard panel lifting at the front to let you see and reach inside; alongside, the column carries the hopper up to height.",
"Il quadro elettrico non è a bordo macchina ma in un armadio a sé, appoggiato al fianco.":"The electrical panel is not on board the machine but in a cabinet of its own, standing against the side.",
"Cesto dentro una cabina chiusa":"Basket inside a closed enclosure",
"Pannello di protezione che si alza sul fronte":"Guard panel that lifts at the front",
"Colonna di carico con la tramoggia in quota":"Loading column with the hopper up high",
"Armadio elettrico separato, a fianco della macchina":"Separate electrical cabinet, alongside the machine",
"Tramoggia di carico servita dal nastro":"Loading hopper fed by the conveyor",
"Scarico sul fronte, sotto il pannello di protezione":"Discharge at the front, under the guard panel",
"Ripari a pavimento attorno alla zona di lavoro":"Floor-mounted guards around the working area",
